...
IGNORE_PATTERNS="SocketException|symbolic link.*file exists|HttpClient.*HTTP Error|CancellationToken|stack trace|System\.Net\.|at System\.|at NzbDrone|An admin is not configured"
